...
/**
 * The MPR list. Rendered as a tab on the inventory page and as the standalone
 * /warehouse/intimation route, which the create and detail screens still
 * navigate back to. `embedded` drops the page header — the inventory page
 * supplies its own — and keeps the New MPR button, which is the only way in.
 */
export function WarehouseIntimationPanel({ embedded = false }: { embedded?: boolean }) {
