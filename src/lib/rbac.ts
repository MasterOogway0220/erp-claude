 ...
 *
 * SUPER_ADMIN — global admin, can switch companies
 * ADMIN — company-level admin, manages employees & masters for their company
 */
 ...
 * ADMIN has full access to company-scoped modules (masters, employees, admin)
 * SUPER_ADMIN has global access across all companies
 */
const MODULE_ACCESS: Record<string, Record<RBACAction, UserRole[]>> = {
  quotation: {
    ...
    delete: ["SALES", "ADMIN", "SUPER_ADMIN"],
    approve: ["MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
  },
  salesOrder: {
    read: ["SALES", "PURCHASE", "STORES", "MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
    write: ["SALES", "ADMIN", "SUPER_ADMIN"],
    delete: ["SALES", "ADMIN", "SUPER_ADMIN"],
    approve: ["MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
  },
  ...
  customerContacts: {
    read: ["SALES", "PURCHASE", "STORES", "QC", "ACCOUNTS", "MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
    write: ["SALES", "ADMIN", "SUPER_ADMIN"],
    delete: ["SALES", "ADMIN", "SUPER_ADMIN"],
    approve: ["ADMIN", "SUPER_ADMIN"],
  },
  purchaseRequisition: {
    read: ["PURCHASE", "SALES", "MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
    write: ["PURCHASE", "SALES", "ADMIN", "SUPER_ADMIN"],
    delete: ["PURCHASE", "ADMIN", "SUPER_ADMIN"],
    approve: ["MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
  },
  purchaseOrder: {
    read: ["PURCHASE", "STORES", "QC", "MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
    write: ["PURCHASE", "ADMIN", "SUPER_ADMIN"],
    delete: ["PURCHASE", "ADMIN", "SUPER_ADMIN"],
    approve: ["MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
  },
  grn: {
    read: ["STORES", "QC", "PURCHASE", "MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
    write: ["STORES", "ADMIN", "SUPER_ADMIN"],
    delete: ["STORES", "ADMIN", "SUPER_ADMIN"],
    approve: ["MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
  },
  inventory: {
    read: ["STORES", "SALES", "QC", "MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
    write: ["STORES", "ADMIN", "SUPER_ADMIN"],
    delete: ["ADMIN", "SUPER_ADMIN"],
    approve: ["MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
  },
  stockIssue: {
    read: ["STORES", "SALES", "MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
    write: ["STORES", "ADMIN", "SUPER_ADMIN"],
    delete: ["ADMIN", "SUPER_ADMIN"],
    approve: ["MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
  },
  ...
  inspectionOffer: {
    ...
    write: ["QC", "SALES", "ADMIN", "SUPER_ADMIN"],
    delete: ["QC", "ADMIN", "SUPER_ADMIN"],
    approve: ["MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
  },
  qcRelease: {
  ...
  ncr: {
    read: ["QC", "PURCHASE", "MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
    write: ["QC", "ADMIN", "SUPER_ADMIN"],
    delete: ["QC", "ADMIN", "SUPER_ADMIN"],
    approve: ["MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
  },
  mtc: {
    read: ["QC", "STORES", "SALES", "MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
    write: ["QC", "STORES", "ADMIN", "SUPER_ADMIN"],
    delete: ["QC", "ADMIN", "SUPER_ADMIN"],
    approve: ["MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
  },
  qualityRequirement: {
    read: ["QC", "STORES", "PURCHASE", "MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
    write: ["QC", "ADMIN", "SUPER_ADMIN"],
    delete: ["QC", "ADMIN", "SUPER_ADMIN"],
    approve: ["MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
  },
  labLetter: {
    read: ["QC", "MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
    write: ["QC", "ADMIN", "SUPER_ADMIN"],
    delete: ["QC", "ADMIN", "SUPER_ADMIN"],
    approve: ["MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
  },
  ...
  packingList: {
    read: ["STORES", "SALES", "ACCOUNTS", "MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
    write: ["STORES", "ADMIN", "SUPER_ADMIN"],
    delete: ["STORES", "ADMIN", "SUPER_ADMIN"],
    approve: ["MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
  },
  ...
  invoice: {
    read: ["ACCOUNTS", "SALES", "MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
    write: ["ACCOUNTS", "ADMIN", "SUPER_ADMIN"],
    delete: ["ADMIN", "SUPER_ADMIN"],
    approve: ["MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
  },
  payment: {
    read: ["ACCOUNTS", "MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
    write: ["ACCOUNTS", "ADMIN", "SUPER_ADMIN"],
    delete: ["ADMIN", "SUPER_ADMIN"],
    approve: ["MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
  },
  masters: {
    read: ["SUPER_ADMIN", "ADMIN", "SALES", "PURCHASE", "STORES", "QC", "ACCOUNTS", "MANAGEMENT"],
  ...
  alerts: {
    read: ["SALES", "PURCHASE", "QC", "STORES", "ACCOUNTS", "MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
    write: ["SALES", "PURCHASE", "QC", "STORES", "ACCOUNTS", "MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
    delete: ["ADMIN", "SUPER_ADMIN"],
    approve: ["ADMIN", "SUPER_ADMIN"],
  },
  warehouseIntimation: {
    read: ["STORES", "SALES", "PURCHASE", "MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
    write: ["STORES", "SALES", "ADMIN", "SUPER_ADMIN"],
    delete: ["STORES", "ADMIN", "SUPER_ADMIN"],
    approve: ["MANAGEMENT", "ADMIN", "SUPER_ADMIN"],
  },
};
