...
> `/api/quality/inspection-offers/[id]/pdfx` — GET
...
Operates on `inspectionOffer`, `companyMaster`, `qualityRequirement`.

- **GET** — Read

## How it works

- Gated by `checkAccess("inspectionOffer", "read")`. **Authentication only** — role enforcement is disabled app-wide.
