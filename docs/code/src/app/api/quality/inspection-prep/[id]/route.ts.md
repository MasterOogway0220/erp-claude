# src/app/api/quality/inspection-prep/[id]/route.ts

> `/api/quality/inspection-prep/[id]` — GET, PATCH
...
- Gated by `checkAccess("inspectionPrep", "read")`, `checkAccess("inspectionPrep", "write")`. **Authentication only** — role enforcement is disabled app-wide.
