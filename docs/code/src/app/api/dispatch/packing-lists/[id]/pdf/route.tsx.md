# src/app/api/dispatch/packing-lists/[id]/pdf/route.tsx

> `/api/dispatch/packing-lists/[id]/pdfx` — GET
...
Operates on `packingList`, `companyMaster`.

- **GET** — Read

## How it works

- Gated by `checkAccess("packingList", "read")`. **Authentication only** — role enforcement is disabled app-wide.
