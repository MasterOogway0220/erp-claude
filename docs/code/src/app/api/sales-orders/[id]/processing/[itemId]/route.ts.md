# src/app/api/sales-orders/[id]/processing/[itemId]/route.ts

> `/api/sales-orders/[id]/processing/[itemId]` — PATCH
...
Operates on `orderProcessingItem`, `salesOrderItem`, `salesOrder`.
