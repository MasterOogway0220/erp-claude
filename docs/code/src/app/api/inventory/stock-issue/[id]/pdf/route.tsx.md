# src/app/api/inventory/stock-issue/[id]/pdf/route.tsx

> `/api/inventory/stock-issue/[id]/pdfx` — GET
...
Operates on `stockIssue`, `companyMaster`.

- **GET** — Read

## How it works

- Gated by `checkAccess("stockIssue", "read")`. **Authentication only** — role enforcement is disabled app-wide.
