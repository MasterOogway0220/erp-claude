...
> `/api/tenders/[id]/documents/[docId]` — DELETE
...
Operates on `tenderDocument`.

- **DELETE** — Delete

## How it works

- Gated by `checkAccess("tender", "delete")`. **Authentication only** — role enforcement is disabled app-wide.
