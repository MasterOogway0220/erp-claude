# src/app/api/masters/company/[id]/route.ts

> `/api/masters/company/[id]` — GET, PATCH, DELETE
...
- Gated by `checkAccess("admin", "delete")`, `checkAccess("admin", "read")`, `checkAccess("admin", "write")`. **Authentication only** — role enforcement is disabled app-wide.
