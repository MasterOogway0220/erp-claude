...
> `/api/masters/customer-contacts` — GET, POST
...
- Gated by `checkAccess("customerContacts", "read")`, `checkAccess("customerContacts", "write")`. **Authentication only** — role enforcement is disabled app-wide.
