...
Renders the `/client-purchase-orders/create` screen. 1641 lines.
...
- Large file (1641 lines). Read the section you are changing rather than pattern-matching from a sibling.
