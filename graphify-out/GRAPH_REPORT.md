...
## Corpus Check
- 496 files · ~473,793 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 863 nodes · 1181 edges · 60 communities detected
...
- **Thin community `Community 40`** (2 nodes): `seed-flange-sizes.ts`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (2 nodes): `weight-calculation.ts`, `calculateWeightPerMeter()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 49`** (2 nodes): `calculateVendorPerformance()`, `fetchPOTracking()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (2 nodes): `fetchAcceptance()`, `updateStatus()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
