...
## Corpus Check
- 498 files · ~536,529 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 897 nodes · 1237 edges · 60 communities detected
...
Cohesion: 0.04
Nodes (15): generateDocumentNumber(), getCurrentFinancialYear(), getShortFinancialYear(), calculateValueDetails(), determineSupplyType(), extractStateCode(), formatDate(), generateEInvoiceJSON() (+7 more)
...
Cohesion: 0.4
Nodes (5): fetchPO(), fetchVariance(), handleApprovalAction(), handleReject(), handleVendorMilestone()
...
Cohesion: 0.5
Nodes (4): fetchAcceptance(), handleSignedCopyRemove(), handleSignedCopyUpload(), updateStatus()
...
## Knowledge Gaps
- **Thin community `Community 36`** (2 nodes): `seed-test-company.ts`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (2 nodes): `seed-test-user.ts`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (2 nodes): `seed-production.ts`, `seedProduction()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (2 nodes): `seed-offer-terms.ts`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 42`** (2 nodes): `otp-client.ts`, `requestLoginOtp()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (2 nodes): `weight-calculation.ts`, `calculateWeightPerMeter()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (2 nodes): `download.ts`, `downloadFile()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (2 nodes): `fetchOffer()`, `handleOfferAction()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (2 nodes): `fetchSalesOrder()`, `handleCancelSO()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (2 nodes): `fetchReport()`, `handleUpdate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (2 nodes): `rebuildItems()`, `toggleItemSelection()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (2 nodes): `download-file.ts`, `downloadFile()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (2 nodes): `formatCurrency()`, `handleExportCSV()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 52`** (2 nodes): `breadcrumbs.tsx`, `isDynamicId()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (2 nodes): `soft-delete.ts`, `softDeleteData()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (1 nodes): `middleware.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
