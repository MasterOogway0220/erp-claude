...
## Corpus Check
- 545 files · ~694,748 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 974 nodes · 1321 edges · 62 communities detected
...
Cohesion: 0.04
Nodes (28): buildAlertData(), createAlert(), escapeHtml(), formatCurrency(), formatDate(), generatePOAcceptanceLetterHtml(), computeChangeSnapshot(), computeCompletion() (+20 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (6): convertBelowThousand(), convertToIndianWords(), convertToWesternWords(), numberToWords(), companyLines(), InspectionOfferDocument()
...
Cohesion: 0.06
Nodes (9): mailer(), mailerConfigured(), missingMailerConfig(), smtpPort(), otpEnabled(), otpRequiredFor(), checkAccess(), checkAuth() (+1 more)

### Community 6 - "Community 6"
Cohesion: 0.09
Nodes (17): findUnpricedItems(), isSettled(), normalizeItemPricing(), parseRate(), unpricedItemsError(), buildItemDescription(), escapeHtml(), formatDate() (+9 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (12): generateDocumentNumber(), getCurrentFinancialYear(), getShortFinancialYear(), calculateValueDetails(), determineSupplyType(), extractStateCode(), formatDate(), generateEInvoiceJSON() (+4 more)
...
Cohesion: 0.12
Nodes (22): detectFieldChanges(), getAuditContext(), getIpAddress(), getUserAgent(), logApproval(), logAudit(), logAuthEvent(), logCreate() (+14 more)
...
## Knowledge Gaps
- **Thin community `Community 33`** (2 nodes): `seed-test-company.ts`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 34`** (2 nodes): `seed-test-user.ts`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (2 nodes): `seed-production.ts`, `seedProduction()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (2 nodes): `seed-offer-terms.ts`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (2 nodes): `migrate-warehouse-details-to-heats.ts`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (2 nodes): `check-recent-logins.ts`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (2 nodes): `rebuildItems()`, `toggleItemSelection()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 41`** (2 nodes): `fetchData()`, `handleFilter()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (2 nodes): `handleApprovalAction()`, `handleReject()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (2 nodes): `download-file.ts`, `downloadFile()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (2 nodes): `fetchRFQ()`, `handleSendToVendors()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 47`** (2 nodes): `handleKeyDown()`, `handleSearch()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (2 nodes): `download.ts`, `downloadFile()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (2 nodes): `calculateVendorPerformance()`, `fetchPOTracking()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (2 nodes): `otp-client.ts`, `requestLoginOtp()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 51`** (2 nodes): `breadcrumbs.tsx`, `isDynamicId()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (2 nodes): `soft-delete.ts`, `softDeleteData()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (1 nodes): `middleware.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (1 nodes): `prisma.config.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 58`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 59`** (1 nodes): `query-provider.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (1 nodes): `prisma.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (1 nodes): `master-cache.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
